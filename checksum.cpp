...
void checkError(int *rComplement)
{
    ...
    if(a ==0)
    {
        printf("Transmitted data is accepted as the result is ACCEPTED.\n\n");
    }
    else
    {   
        printf("Transmitted data is discarded as the result is not ACCEPTED.\n\n");
    }
}
...
int main()
{
    ...
    printf("Enter the length of message in bits:");         
    scanf("%d", &lengthInBit);
    printf("\n");
